...
const tokenAction = function (genStats) {
  ...
  const chooseTokens = "Remove your toothpicks of choice...";
  const lockedTokens = "Please choose toothpicks from current row!";
  ...
  return function (evt) {
    if (genStats.gameActive == true) {
      ...
      if (evt.target.locked == false) {
        ...
        status.textContent = chooseTokens;
        /* status.textContent = "get tokens"; */
        /* document.querySelector(".status").textContent =
          "Remove your toothpicks of choice..."; */
      } else {
        /* updateStatus("locked", true); */
        status.textContent = lockedTokens;
        console.log("LOCKED!!!");
      }
      setTimeout(function () {
        status.textContent = chooseTokens;
